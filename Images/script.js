...
// =====================================
// EVENT CARDS - CLICK TO TOGGLE DETAILS
// =====================================
const eventCards = document.querySelectorAll('.event-card');

eventCards.forEach(card => {
    card.addEventListener('click', function(e) {
        // Prevent clicks on links inside the card from toggling
        if (e.target.tagName === 'A') return;
        
        // Close all other event cards
...
// =====================================
// TEAM MEMBERS - CLICK TO TOGGLE DETAILS
// =====================================
const teamMembers = document.querySelectorAll('.team-member');

teamMembers.forEach(member => {
    member.addEventListener('click', function(e) {
        // Prevent clicks on links inside the member card from toggling
        if (e.target.tagName === 'A') return;
        
        // Close all other team members
...
document.addEventListener('click', function(e) {
    // Check if click is outside any event card
    ...
    // Check if click is outside any team member
...
// =====================================
// Allow Enter/Space to toggle cards
eventCards.forEach(card => {
    card.setAttribute('tabindex', '0');
    card.setAttribute('role', 'button');
    card.setAttribute('aria-label', 'Click to view event details');
...
teamMembers.forEach(member => {
    ...
    member.setAttribute('aria-label', 'Click to view member details');
...
console.log('%c👆 Click on event cards and team members to view details', 'color: #F4E5B5; font-size: 12px;');
